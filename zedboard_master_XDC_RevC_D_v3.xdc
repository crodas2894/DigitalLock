...
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN P16 [get_ports {button[0]}];  # "BTNCenter"
set_property PACKAGE_PIN R16 [get_ports {button[1]}];  # "BTNSouth"
set_property PACKAGE_PIN N15 [get_ports {button[2]}];  # "BTNWest"
set_property PACKAGE_PIN R18 [get_ports {button[3]}];  # "BTNEast"
set_property PACKAGE_PIN T18 [get_ports {button[4]}];  # "BTNNorth"
